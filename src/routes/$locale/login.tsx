...
export const Route = createFileRoute("/$locale/login")({
  ...
  component: LocaleLoginPage,
});

export function LocaleLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans text-foreground">
      <SiteHeader currentPath={`/${locale}/login`} />
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="pt-2 space-y-3">
                ...
                >
                  {isLoggingOut ? (
                    <>
                      ...
                      <span>{locale === "en" ? "Logging out..." : "Đang đăng xuất..."}</span>
                    </>
                  ) : (
                    <>
                ...
                >
                  ...
                  <span>{locale === "en" ? "Back to Random Tool" : "Quay lại Tool Random"}</span>
                </Link>
              </div>
            </div>
          ) : (
            <div className="space-y-6">
              <p className="text-xs text-center text-muted-foreground leading-relaxed">
                {locale === "en"
                  ? "Sign in using your Google account via Supabase Authentication service."
                  : "Đăng nhập bằng tài khoản Google của bạn thông qua dịch vụ bảo mật Supabase Authentication."}
              </p>
                ...
                >
                  ...
                  <span>
                    {locale === "en"
                      ...
                      : "Trở về trang chủ mà không cần đăng nhập"}
                  </span>
                </Link>
              </div>
            </div>
