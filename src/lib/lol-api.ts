...
export const ROLE_META: Record<Role, { label: string; iconUrl: string; color: string }> = {
  TOP: {
    label: "Top",
    iconUrl: "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-static-assets/global/default/svg/position-top.svg",
    color: "oklch(0.70 0.14 60)",
  },
  JUNGLE: {
    label: "Jungle",
    iconUrl: "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-static-assets/global/default/svg/position-jungle.svg",
    color: "oklch(0.65 0.16 145)",
  },
  MID: {
    label: "Mid",
    iconUrl: "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-static-assets/global/default/svg/position-middle.svg",
    color: "oklch(0.72 0.16 320)",
  },
  ADC: {
    label: "ADC",
    iconUrl: "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-static-assets/global/default/svg/position-bottom.svg",
    color: "oklch(0.70 0.18 30)",
  },
  SUPPORT: {
    label: "Support",
    iconUrl: "https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-static-assets/global/default/svg/position-utility.svg",
